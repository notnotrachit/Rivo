    ...
    <AppView>
      <ScrollView style={styles.scrollView}>
        <View style={styles.container}>
          ...
          <AppText style={styles.subtitle}>Send USDC to linked wallets or unlinked social handles</AppText>
          ...
          <View style={styles.section}>
            ...
            >
              {loading ? <ActivityIndicator color="white" /> : <Text style={styles.buttonText}>Check Recipient</Text>}
            </TouchableOpacity>
          </View>
